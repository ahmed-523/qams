...
<a href="{{ route('teacher.assignments.index') }}" class="active"><i
        class="bi bi-file-earmark-text me-2"></i>Assignments</a>
        ...
        <form action="{{ route('teacher.assignments.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" class="form-control form-control-lg shadow-sm" required
                    value="{{ old('title') }}" placeholder="e.g. Assignment 1">
            </div>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="total_marks" class="form-control shadow-sm" min="1"
            ...
            <div class="mb-4">
                ...
                <div class="form-text mt-2"><i class="bi bi-info-circle me-1"></i>Choose how students will submit their
                    answers for this assignment.</div>
            </div>
            ...
            <div class="d-flex justify-content-end gap-2 mt-2">
                ...
                <button type="submit" class="btn btn-primary px-4 shadow-sm"><i class="bi bi-check2-circle me-1"></i>
