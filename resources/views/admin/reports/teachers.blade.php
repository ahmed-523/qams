    ...
    <div class="card-body p-0">
        <table class="table table-hover mb-0">
            <thead class="table-light">
                <tr><th>Teacher</th><th>Username</th><th>Subjects</th><th>Quizzes Created</th><th>Assignments Created</th><th>Status</th></tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>@if($teacher->user->is_blocked)<span class="badge bg-danger">Blocked</span>@else<span class="badge bg-success">Active</span>@endif</td>
                </tr>
                @empty
