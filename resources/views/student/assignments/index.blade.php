    ...
    <div class="card-body p-0">
        <table class="table table-hover mb-0">
            <thead class="table-light">
                <tr><th>#</th><th>Title</th><th>Subject</th><th>Total Marks</th><th>Deadline</th><th>Status</th><th>Action</th></tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('student.assignments.show', $a) }}" class="btn btn-sm {{ $submitted->contains($a->id) ? 'btn-outline-info' : 'btn-primary' }}">
