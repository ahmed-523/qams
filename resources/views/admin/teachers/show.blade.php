...
<div class="card mb-4">
    <div class="card-body d-flex align-items-center gap-4">
        ...
        <div class="flex-grow-1">
            ...
            <span class="text-muted me-3"><code>{{ $teacher->user->username }}</code></span>
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <div class="text-center text-muted py-4">
                    ...
                    <p class="mt-2 mb-0">No subjects assigned yet.<br>Use the form on the right to assign subjects.</p>
                </div>
                @endforelse
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                @else
                    <form action="{{ route('admin.teachers.assign-subject', $teacher) }}" method="POST">
                        ...
                        <select name="subject_id" class="form-select form-select-lg mb-3" required>
