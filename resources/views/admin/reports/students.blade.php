...
<div class="row g-3">
    <div class="col-md-4">
        <div class="card p-3 text-center">
            ...
            <p class="mb-1 text-muted">{{ $report->admission_number }}</p>
        ...
        <div class="card mb-3">
            ...
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    @empty
                    <tr><td colspan="4" class="text-muted text-center">No attempts yet.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
            ...
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $sub->grade ?? '-' }}</td>
                        <td>@if($sub->is_zero_marked)<span class="badge bg-danger">Late/Zero</span>@elseif($sub->is_late)<span class="badge bg-warning">Late</span>@else<span class="badge bg-success">On Time</span>@endif</td>
                    </tr>
                    @empty
                    <tr><td colspan="4" class="text-muted text-center">No submissions yet.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
...
@else
<div class="alert alert-info">Select a student above to view their report.</div>
@endif
@endsection
