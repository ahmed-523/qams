    ...
    <div class="card-body">
        ...
        <div class="alert alert-info d-flex align-items-center gap-3 mb-0">
            ...
            <div>
                ...
                <a href="{{ asset('storage/' . $assignment->document_path) }}" target="_blank" class="btn btn-sm btn-outline-primary mt-1">
...
<div class="d-flex gap-2">
    <a href="{{ route('teacher.assignments.submissions', $assignment) }}" class="btn btn-primary"><i class="bi bi-list-check me-1"></i>View Submissions</a>
    <a href="{{ route('teacher.assignments.edit', $assignment) }}" class="btn btn-outline-warning"><i class="bi bi-pencil me-1"></i>Edit</a>
</div>
@endsection
